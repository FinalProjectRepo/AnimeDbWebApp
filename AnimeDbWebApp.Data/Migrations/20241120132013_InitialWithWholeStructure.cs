...
{
    /// <inheritdoc />
    public partial class InitialWithWholeStructure : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Id = table.Column<int>(type: "int", nullable: false, comment: "Unique identifier of manga"),
                    WatchingStatus = table.Column<int>(type: "int", nullable: false, comment: "Watching status")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersMangas", x => new { x.Id, x.UserId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "User unique identifier"),
                    Id = table.Column<int>(type: "int", nullable: false, comment: "Unique identifier of anime"),
                    WatchingStatus = table.Column<int>(type: "int", nullable: false, comment: "Watching status")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersAnimes", x => new { x.Id, x.UserId });
                    table.ForeignKey(
                        name: "FK_UsersAnimes_Animes_Id",
                        column: x => x.Id,
                        principalTable: "Animes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
